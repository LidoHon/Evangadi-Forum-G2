...
const Teams = [
  ...
  {
    Name: "Melat",
    portfolio: "https://www.melattesfaye.com",
    github: "https://github.com/Melat369",
    linkedin: "https://www.linkedin.com/in/melattesfayesisay/",
    image: "https://randomuser.me/api/portraits/men/2.jpg",
  },
  {
    Name: "Metadel",
...
const HowItWorks = () => {
  return (
    <section className="container mx-auto bg-slate-50 rounded-lg py-10 px-6 md:px-12 max-w-[1350px]">
      ...
      <div className="flex flex-col ">
        ...
        <div className="max-w-5xl gap-5 mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          {Teams.map((team, index) => (
            <div
              key={team.id}
              className="bg-black/10 p-8 rounded-xl shadow-2xl transform transition-transform duration-200 hover:scale-95 hover:bg-orange-800 hover:text-white"
            >
              {/* <img
			...
			/> */}
              ...
              <div className="flex justify-center gap-4 mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-800 hover:text-slate-50 "
                >
                  <FaLinkedin size={24} />
                </a>
                <a
