...
const SavedQuestions = ({ savedQuestions, setSavedQuestions }) => {
	...
	return (
    <div className="p-4 flex  flex-col lg:flex-row  h-full container lg:min-w-[1350px] md:min-w-[800px] ms-20">
      <div className=" mb-3 lg:mb-4 flex flex-col gap-2 lg:bg-orange-50 rounded-lg  lg:w-1/3 group lg:h-40 shadow-md items-center">
      ...
      <div className="relative h-[500px] overflow-y-auto w-full lg:w-3/6">
        {savedQuestions.length > 0 ? (
          <ul className="space-y-4 w-full lg:w-5/6 pt-4 lg:pt-0 mx-auto group">
